...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <div className={classNames(style.flex)}>
        <p className={classNames(style.p)}>haditg specific book metadata</p>
        <p className={classNames(style.p)}>
      ...
      <div className={classNames(style.flex)}>
        ...
        <a
          href={`${domain}/api/hadith/abudawud/arabic/chapter1`}
          target="_blank"
          className={classNames(style.a)}
        >
          {domain}/api/hadith/abudawud/arabic/chapter1
        </a>
      </div>
      <div className={classNames(style.flex)}>
        <p className={classNames(style.p)}>
        ...
        <a
          href={`${domain}/api/hadith/abudawud/arabic/verse1`}
          target="_blank"
          className={classNames(style.a)}
        >
          {domain}/api/hadith/abudawud/arabic/verse1
        </a>
      </div>
    </>
  );
